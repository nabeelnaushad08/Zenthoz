      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-16 relative z-10">
            ...
            <div className="glass-card rounded-2xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <div className="text-xs text-slate-400">Get a reply in under 30 minutes</div>
                </div>
              </div>
              <a
        ...
        <div className="max-w-3xl mx-auto mt-20">
          ...
          <div className="space-y-4">
            {[
              {
                q: "Do I need to have a trade license already?",
                a: "No! We can help you plan your digital strategy even before you have a trade license. We'll be ready to launch the moment you're registered.",
              },
              {
                q: "How soon will my website be live?",
                a: "Most websites go live within 7–14 days of project kickoff. Our 14-day delivery guarantee backs this up.",
              },
              {
                q: "What if I'm not happy with the result?",
                a: "We offer unlimited revisions until you're 100% satisfied. Your success is our priority.",
              },
              {
                q: "Do you support Arabic language?",
                a: "Yes! We build bilingual (Arabic & English) websites for UAE businesses that want to reach all customer segments.",
              },
              {
                q: "Is there a long-term contract?",
                a: "Monthly retainers can be cancelled with 30 days notice. No lock-in contracts. One-time packages have no recurring fees.",
              },
            ].map((faq, i) => (
              <motion.div
                key={i}
