...
export const metadata: Metadata = {
  ...
  description:
    "Contact Zenthoz UAE today. WhatsApp +971 54 198 9921 or email info@zenthoz.com. Based in Dubai — serving all UAE. Free consultation available. Reply within 2 hours.",
  keywords: [
    "contact Zenthoz UAE",
