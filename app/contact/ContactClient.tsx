    ...
    <div className="pt-20 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-20 relative z-10">
        <div className="text-center mb-16">
          ...
          >
            Ready to launch your business online? Reach out via WhatsApp, call, email, or fill in the form.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          <div>
            ...
            <div className="space-y-4 mb-10">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-slate-300 text-sm font-medium">{PHONE_DISPLAY}</div>
                  <div className="text-green-400 text-xs mt-0.5">Fastest — reply under 30 min</div>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-slate-300 text-sm font-medium">{PHONE_DISPLAY}</div>
                  <div className="text-slate-500 text-xs mt-0.5">Sun–Thu 9am–6pm UAE time</div>
                </div>
              </a>

              <a
                href={`mailto:${EMAIL}`}
                className="flex items-center gap-4 glass-card rounded-2xl p-5 group hover:border-purple-500/40 transition-all"
              >
                <div className="w-12 h-12 rounded-xl bg-purple-600/20 border border-purple-500/30 flex items-center justify-center shrink-0 group-hover:bg-purple-600/30 transition-colors">
                  <Mail className="w-6 h-6 text-purple-400" />
                </div>
                <div>
                  <div className="font-semibold text-white">Email</div>
                  <div className="text-slate-300 text-sm font-medium">{EMAIL}</div>
                  <div className="text-slate-500 text-xs mt-0.5">Reply within 4 business hours</div>
                </div>
              </a>
              ...
              <div className="flex items-center gap-4 glass-card rounded-2xl p-5">
                ...
                <div>
                  ...
                  <div className="text-slate-300 text-sm">Sunday – Thursday: 9am – 6pm</div>
                  <div className="text-slate-300 text-sm">Saturday: 10am – 2pm</div>
                  <div className="text-green-400 text-xs mt-0.5">WhatsApp available 7 days</div>
                </div>
              </div>
            </div>
            ...
            >
              <h3 className="font-bold text-white mb-2">Prefer to Chat Directly?</h3>
              <p className="text-slate-400 text-sm mb-4">Message us on WhatsApp — reply in under 30 minutes.</p>
              <a
          ...
          <div>
            <LeadForm
              ...
              subtitle={`We'll reply within 2 hours • ${EMAIL}`}
            />
          </div>
        </div>
      </div>
